...
def one_time_pad_code(key_file_name, encryption_file_name, encrypted_file_name, process_show):
    with open(key_file_name, encoding='utf-8') as key_file_txt:
        with open(encryption_file_name, encoding='utf-8') as encryption_file_txt:
            with open(encrypted_file_name, 'w', encoding='utf-8') as encrypted_file_txt:
                ...
                encrypted_text = ''.join(
                    alphabet[char_code - 1] for char_code in encryption_code
                )
...
def one_time_pad_decode(key_file_name, message_file_name, encrypted_file_name, process_show):
    with open(key_file_name, encoding='utf-8') as key_file:
        with open(encrypted_file_name, encoding='utf-8') as encrypted_file:
            ...
            message_text = ''.join(alphabet[char_code - 1] for char_code in message_code)
